...
export const STATIC_ADMIN_ROUTE_PERMISSIONS = {
  ...
  "/events": ["beaulab.hospital_event.show"],
  "/ads/events": ["common.access"],
  "/ads/products": ["common.access"],
  "/ads/calendar": ["common.access"],
  "/talks": ["beaulab.talk.show"],
  "/reviews/surgery-reviews": ["beaulab.hospital_review.show"],
  "/reviews/treatment-reviews": ["beaulab.hospital_review.show"],
  "/reviews/hospital-evaluations": ["beaulab.hospital_evaluation.show"],
  "/posts/talks": ["beaulab.talk.show"],
...
export const ADMIN_ROUTE_PERMISSION_RULES: RoutePermissionRule[] = [
  ...
  { path: "/events/[id]", requiredPermissions: ["beaulab.hospital_event.show"] },
  { path: "/events/[id]/edit", requiredPermissions: ["beaulab.hospital_event.update"] },
  { path: "/events/new", requiredPermissions: ["beaulab.hospital_event.create"] },
