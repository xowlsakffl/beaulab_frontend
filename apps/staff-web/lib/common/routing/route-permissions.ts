...
export const STATIC_ADMIN_ROUTE_PERMISSIONS = {
  ...
  "/admin-settings/db-pricing": ["beaulab.db_pricing.manage"],
  "/admin-settings/ad-pricing": ["beaulab.ad_pricing.manage"],
  ...
  "/video-manage/consents": ["beaulab.video.show"],
  ...
  "/content-manage/exhibitions": ["beaulab.category.manage"],
  "/content-manage/videos": ["beaulab.video.show"],
  ...
  "/beauty-promotion-manage/beauties": ["beaulab.beauty.show"],
