    ...
    <div className="rounded-2xl border border-gray-200 p-5  lg:p-6">
      <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
        <div className="flex w-full flex-col items-center gap-6 xl:flex-row">
          ...
          <div>
            <h4 className="mb-2 text-center text-lg font-semibold text-gray-800  xl:text-left">{name}</h4>
            <div className="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
              {subtitle ? <p className="text-sm text-gray-500 ">{subtitle}</p> : null}
              {subtitle && location ? <div className="hidden h-3.5 w-px bg-gray-300  xl:block"></div> : null}
