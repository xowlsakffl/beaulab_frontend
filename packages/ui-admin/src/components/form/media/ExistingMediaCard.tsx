...
import { GripVertical, Image as ImageIcon, Star, X } from "../../../icons";
import { Button } from "../../ui/button/Button";
import { MediaImagePreview } from "./MediaUploaderPrimitives";
import type { ExistingMediaItem, MediaCardVariant, MediaUploaderPreviewPayload } from "./MediaUploader.types";
import { formatBytes } from "./media-utils";
import { clearDragPreview, createDragPreview } from "./media-drag-preview";

export function ExistingMediaCard({
  item,
  multiple,
  isRepresentative,
  isDragging = false,
